...
public class New4 {
    ...
    private static final double thickness = .45;
    private final static int unum = 28;
    ...
    private static Point[][] points(Bezier template) {
        ...
        Point[] centers;
        if (secondset) {
            centers = template.renderSpecial2(upoints + 1, .5);

        } else {
            centers = template.renderSpecial(upoints + 1, .5);
        }
        secondset = !secondset;
    ...
    private static Point[][] shrunkPoints(Bezier template,
        ...
        Point[] tempCenters;
        if (secondset) {
            tempCenters = template.renderSpecial2(upoints + 1, .5);

        } else {
            tempCenters = template.renderSpecial(upoints + 1, .5);
        }
